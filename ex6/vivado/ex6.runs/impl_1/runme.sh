...
HD_PWD='/home/vlsi1_010hs23/ex6/vivado/ex6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_top_wrapper.tcl -notrace
