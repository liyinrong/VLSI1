...
# HDMI Rx
# --------------------------------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports hdmi_rx_hpd_o]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports hdmi_rx_ddc_scl_io]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports hdmi_rx_ddc_sda_io]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD TMDS_33} [get_ports hdmi_rx_clk_n_i]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD TMDS_33} [get_ports hdmi_rx_clk_p_i]
set_property -dict {PACKAGE_PIN W20 IOSTANDARD TMDS_33} [get_ports {hdmi_rx_n_i[0]}]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD TMDS_33} [get_ports {hdmi_rx_p_i[0]}]
set_property -dict {PACKAGE_PIN U20 IOSTANDARD TMDS_33} [get_ports {hdmi_rx_n_i[1]}]
set_property -dict {PACKAGE_PIN T20 IOSTANDARD TMDS_33} [get_ports {hdmi_rx_p_i[1]}]
set_property -dict {PACKAGE_PIN P20 IOSTANDARD TMDS_33} [get_ports {hdmi_rx_n_i[2]}]
set_property -dict {PACKAGE_PIN N20 IOSTANDARD TMDS_33} [get_ports {hdmi_rx_p_i[2]}]
...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD TMDS_33} [get_ports hdmi_tx_clk_n_o]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD TMDS_33} [get_ports hdmi_tx_clk_p_o]
set_property -dict {PACKAGE_PIN D20 IOSTANDARD TMDS_33} [get_ports {hdmi_tx_n_o[0]}]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD TMDS_33} [get_ports {hdmi_tx_p_o[0]}]
set_property -dict {PACKAGE_PIN B20 IOSTANDARD TMDS_33} [get_ports {hdmi_tx_n_o[1]}]
set_property -dict {PACKAGE_PIN C20 IOSTANDARD TMDS_33} [get_ports {hdmi_tx_p_o[1]}]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD TMDS_33} [get_ports {hdmi_tx_n_o[2]}]
set_property -dict {PACKAGE_PIN B19 IOSTANDARD TMDS_33} [get_ports {hdmi_tx_p_o[2]}]
...
# False Paths
# --------------------------------------------------------------------------------------------------
set_false_path -from [get_pins zybo_top_i/hdmi_rx/dvi2rgb/U0/TMDS_ClockingX/aLocked_reg/C] -to [get_pins {zybo_top_i/hdmi_tx/dc_fifo/U0/inst_fifo_gen/gconvfifo.rf/gbi.bi/v7_bi_fifo.fblk/gextw[1].gnll_fifo.inst_extd/gonep.inst_prim/gf18e1_inst.sngfifo18e1/RDEN}]
set_false_path -from [get_pins zybo_top_i/hdmi_rx/dvi2rgb/U0/TMDS_ClockingX/aLocked_reg/C] -to [get_pins {zybo_top_i/hdmi_rx/dc_fifo/U0/inst_fifo_gen/gconvfifo.rf/gbi.bi/v7_bi_fifo.fblk/gextw[1].gnll_fifo.inst_extd/gonep.inst_prim/gf18e1_inst.sngfifo18e1/WREN}]
#set_false_path -from [get_clocks PixelClk_int] -to [get_clocks PixelClk]

# --------------------------------------------------------------------------------------------------
# Internal clock domains
# --------------------------------------------------------------------------------------------------
#create_generated_clock -name PixelClk #    -source [get_pins zybo_top_i/hdmi_rx/clk_gen/clk_out1] #    -divide_by 10 -multiply_by 8 #    [get_pins zybo_top_i/hdmi_rx/dvi2rgb/PixelClk]
