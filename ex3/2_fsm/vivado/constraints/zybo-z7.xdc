...
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN Y11  IOSTANDARD LVCMOS33 }     [get_ports { led5_r_o }];       #IO_L18N_T2_13              Sch=led5_r
#set_property -dict { PACKAGE_PIN T5   IOSTANDARD LVCMOS33 }     [get_ports { led5_g_o }];       #IO_L19P_T3_13              Sch=led5_g
#set_property -dict { PACKAGE_PIN Y12  IOSTANDARD LVCMOS33 }     [get_ports { led5_b_o }];       #IO_L20P_T3_13              Sch=led5_b

# --------------------------------------------------------------------------------------------------
# RGB LED 6
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 }     [get_ports { led6_r_o }];       #IO_L18P_T2_34              Sch=led6_r
#set_property -dict { PACKAGE_PIN F17  IOSTANDARD LVCMOS33 }     [get_ports { led6_g_o }];       #IO_L6N_T0_VREF_35          Sch=led6_g
#set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS33 }     [get_ports { led6_b_o }];       #IO_L8P_T1_AD10P_35         Sch=led6_b

# --------------------------------------------------------------------------------------------------
# I2S Audio Codec
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN R19  IOSTANDARD LVCMOS33 }     [get_ports { ac_b_clk_o }];     #IO_0_34                    Sch=ac_bclk
#set_property -dict { PACKAGE_PIN R17  IOSTANDARD LVCMOS33 }     [get_ports { ac_m_clk_o }];     #IO_L19N_T3_VREF_34         Sch=ac_mclk
#set_property -dict { PACKAGE_PIN P18  IOSTANDARD LVCMOS33 }     [get_ports { ac_mute_o }];      #IO_L23N_T3_34              Sch=ac_muten
#set_property -dict { PACKAGE_PIN R18  IOSTANDARD LVCMOS33 }     [get_ports { ac_play_dat_o }];  #IO_L20N_T3_34              Sch=ac_pbdat
#set_property -dict { PACKAGE_PIN T19  IOSTANDARD LVCMOS33 }     [get_ports { ac_p_clk_o }];     #IO_25_34                   Sch=ac_pblrc
#set_property -dict { PACKAGE_PIN R16  IOSTANDARD LVCMOS33 }     [get_ports { ac_rec_dat_i }];   #IO_L19P_T3_34              Sch=ac_recdat
#set_property -dict { PACKAGE_PIN Y18  IOSTANDARD LVCMOS33 }     [get_ports { ac_rec_clk_o }];   #IO_L17P_T2_34              Sch=ac_reclrc
#set_property -dict { PACKAGE_PIN N18  IOSTANDARD LVCMOS33 }     [get_ports { ac_rec_dat_i }];   #IO_L13P_T2_MRCC_34         Sch=ac_scl
#set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 }     [get_ports { ac_rec_clk_o }];   #IO_L23P_T3_34              Sch=ac_sda
...
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN F16  IOSTANDARD LVCMOS33  PULLUP true } [get_ports { eth_int_b_i }];   #IO_L6P_T0_35       Sch=eth_int_pu_b
#set_property -dict { PACKAGE_PIN E17  IOSTANDARD LVCMOS33 }     [get_ports { eth_rst_b_o }];    #IO_L3P_T0_DQS_AD1P_35      Sch=eth_rst_b

# --------------------------------------------------------------------------------------------------
# USB OTG Overcurrent Detection Pin
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN U13  IOSTANDARD LVCMOS33 }     [get_ports { otg_oc_i }];       #IO_L3P_T0_DQS_PUDC_B_34    Sch=otg_oc

# --------------------------------------------------------------------------------------------------
# Fan (Zybo Z7-20 only)
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN Y13  IOSTANDARD LVCMOS33  PULLUP true } [get_ports { fan_fb_pu_o }];   #IO_L20N_T3_13      Sch=fan_fb_pu
...
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN Y8   IOSTANDARD LVCMOS33 }     [get_ports { hdmi_rx_cec_io }];     #IO_L14N_T2_SRCC_13     Sch=hdmi_rx_cec

# --------------------------------------------------------------------------------------------------
# HDMI Tx
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN E18  IOSTANDARD LVCMOS33 }     [get_ports { hdmi_tx_hpd_i }];      #IO_L5P_T0_AD9P_35      Sch=hdmi_tx_hpd
...
# HDMI Tx CEC
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 }     [get_ports { hdmi_tx_cec_io }];     #IO_L5N_T0_AD9N_35      Sch=hdmi_tx_cec
...
# --------------------------------------------------------------------------------------------------
# This configuration expects the sensor to use 672 Mbps/lane = 336 hs_clk
#create_clock -period 2.976 -name dphy_hs_clk_p -waveform {0.000 1.488}      [get_ports {dphy_hs_clk_p} ];
...
#set_property -dict { PACKAGE_PIN H18  IOSTANDARD LVDS_25                }   [get_ports { dphy_hs_clk_n }];      #IO_L14N_T2_AD4N_SRCC_35    Sch=mipi_clk_n
#set_property -dict { PACKAGE_PIN J18  IOSTANDARD LVDS_25                }   [get_ports { dphy_hs_clk_p }];      #IO_L14P_T2_AD4P_SRCC_35    Sch=mipi_clk_p
...
set_false_path \
    ...
    -to [get_pins {zybo_top_i/hdmi_tx/dc_fifo/U0/inst_fifo_gen/gconvfifo.rf/gbi.bi/v7_bi_fifo.fblk/gextw[1].gnll_fifo.inst_extd/gonep.inst_prim/gf18e1_inst.sngfifo18e1/RDEN}]
set_false_path \
    -from [get_pins zybo_top_i/hdmi_rx/dvi2rgb/U0/TMDS_ClockingX/aLocked_reg/C] \
    -to [get_pins {zybo_top_i/hdmi_rx/dc_fifo/U0/inst_fifo_gen/gconvfifo.rf/gbi.bi/v7_bi_fifo.fblk/gextw[1].gnll_fifo.inst_extd/gonep.inst_prim/gf18e1_inst.sngfifo18e1/WREN}]
#set_false_path -from [get_clocks PixelClk_int] -to [get_clocks PixelClk]

# --------------------------------------------------------------------------------------------------
# Internal clock domains
# --------------------------------------------------------------------------------------------------
#create_generated_clock -name PixelClk \
#    -source [get_pins zybo_top_i/hdmi_rx/clk_gen/clk_out1] \
#    -divide_by 10 -multiply_by 8 \
#    [get_pins zybo_top_i/hdmi_rx/dvi2rgb/PixelClk]
