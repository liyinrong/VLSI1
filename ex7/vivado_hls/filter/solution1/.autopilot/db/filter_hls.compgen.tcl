...
set ID 1
set MemName filter_hls_lines_bkb
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_in_TDATA { I 24 vector } data_in_TVALID { I 1 bit } data_in_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_out_TDATA { O 24 vector } data_out_TVALID { O 1 bit } data_out_TREADY { I 1 bit } } \
} "
} else {
