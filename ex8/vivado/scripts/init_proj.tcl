...
# Generate BRAM instantiation
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.3 -module_name bram
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} \
                        ...
                        CONFIG.Port_B_Enable_Rate {100}] [get_ips bram]
set_property generate_synth_checkpoint 0 [get_files bram.xci]
...
set_property top rgb_filter_tb [get_filesets sim_1]
